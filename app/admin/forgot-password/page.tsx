...
const AdminForgotPasswordPage = async () => {
  ...
  return (
    <main className="min-h-screen flex bg-[#f8fbff] overflow-hidden">
      <ForgotPasswordBrandPanel description="Reset your admin access securely with an OTP sent to your registered email." />
      ...
      <section className="flex-1 flex items-center justify-center px-5 sm:px-8 md:px-12 py-10 min-h-screen relative">
        ...
        <div className="relative z-10 w-full max-w-110">
          ...
          <ForgotPasswordForm
            heading="Forgot your admin password?"
            subHeading="Enter your registered admin email to receive a 6 digit OTP and reset your password."
